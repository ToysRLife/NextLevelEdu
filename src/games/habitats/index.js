...
class Habitats {
    constructor(ctx) {
        ...
        Object.defineProperty(this, "flashZone", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: null
    ...
    buildPanel() {
        ...
        this.ctx.panel.append(el("div", { class: "metric", style: { background: "#1e293b", color: "#fff" } }, el("span", {}, "🎯 Goal"), el("span", {}, "Send each animal home")), el("div", { class: "control-label", style: { marginTop: "8px" } }, "Drag the animal to its habitat"), el("div", { class: "metric" }, el("span", {}, "🐾 Animal"), this.progressEl), this.coachEl);
    }
    zoneAt(p) {
    ...
    win() {
        ...
        this.ctx.services.outcome.succeed({
            message: "Everyone's home! A habitat gives an animal what it needs — food, water, and shelter. Different animals are suited to different homes.",
            stars,
    ...
    render() {
        ...
        if (!this.dragging)
            c.fillText(`Drag the ${cur.name}`, this.tok.x, this.tok.y + 64);
        c.fillStyle = "#166534";
