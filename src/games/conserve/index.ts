...
class Conserve implements GameInstance {
  ...
  private buildPanel(): void {
    ...
    this.ctx.panel.append(
      el(
        ...
        el("span", {}, "🌍 Action"),
        el("span", {}, `${this.idx + 1}/${ACTIONS.length}`)
      ),
      el(
        "div",
        { class: "control-label", style: { marginTop: "8px" } },
        "Helps or harms the planet?"
      ),
      choices,
  ...
  private win(): void {
    ...
    this.ctx.services.outcome.succeed({
      message:
        "Planet protector! Conservation means saving energy, water, and materials — and not polluting — so Earth stays healthy for everyone.",
      stars,
