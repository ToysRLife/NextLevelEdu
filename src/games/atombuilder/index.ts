...
class AtomBuilder implements GameInstance {
  ...
  private pCtl!: SliderHandle;
  private nCtl!: SliderHandle;
  private eCtl!: SliderHandle;
  private elRead!: { el: HTMLElement; set(v: string): void };
  ...
  private win(): void {
    ...
    this.ctx.services.outcome.succeed({
      message:
        "Atom architect! Protons decide the element, neutrons set its mass, and matching electrons keep it neutral. That's how every atom is built.",
      stars,
...
export const atomBuilderGame: GameModule = {
  meta: {
    id: "atombuilder",
    conceptId: "chem-26",
    title: "Atom Builder",
