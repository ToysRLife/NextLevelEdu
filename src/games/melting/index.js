...
class Melting {
    ...
    buildPanel() {
        ...
        this.ctx.panel.append(el("div", { class: "metric", style: { background: "#1e293b", color: "#fff" } }, el("span", {}, "🎯 Make"), el("span", {}, `${this.target().emoji} ${this.target().label}`)), el("div", { class: "control-label", style: { marginTop: "8px" } }, "🌡️ Temperature (°C)"), slider, el("div", { class: "metric" }, el("span", {}, "🔬 State now"), this.stateEl), el("div", { class: "metric" }, el("span", {}, "✅ Matched"), this.statusEl), this.coachEl);
        this.updateReadout();
    }
    updateReadout() {
        const s = this.state();
    ...
    finish() {
        ...
        this.ctx.services.outcome.succeed({
            message: "State changer! Water freezes to ice at 0°C and boils to steam at 100°C — and it's all reversible. Heat melts and boils; cooling freezes and condenses.",
            stars,
            resources: { Energy: 40 },
        });
    }
