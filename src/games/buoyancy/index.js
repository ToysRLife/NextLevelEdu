...
class Buoyancy {
    constructor(ctx) {
        ...
        Object.defineProperty(this, "hollow", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: 0
        }); // 0..0.9 — fraction of volume hollowed out (air)
        ...
        Object.defineProperty(this, "settleFrames", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: 0
        });
        Object.defineProperty(this, "densEl", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        });
        Object.defineProperty(this, "predictEl", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        ...
        Object.defineProperty(this, "chips", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        });
        Object.defineProperty(this, "dropBtn", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
    ...
    buildPanel() {
        this.chips = el("div", { class: "chip-row" }, ...MATERIALS.map((m) => el("button", {
        ...
        const slider = el("input", {
            ...
            oninput: (e) => {
                if (this.phase !== "setup")
                    return;
                this.hollow = Number(e.target.value) / 100;
                this.updateReadout();
                this.render();
            },
        });
        ...
        this.ctx.panel.append(el("div", { class: "metric", style: { background: "#1e293b", color: "#fff" } }, el("span", {}, "🎯 Goal"), el("span", {}, this.target === "float" ? "Make it FLOAT" : "Make it SINK")), el("div", { class: "control-label", style: { marginTop: "8px" } }, "Material"), this.chips, el("div", { class: "control-label", style: { marginTop: "8px" } }, "Hollow It Out (add air)"), slider, el("div", { class: "metric" }, el("span", {}, "⚖️ Density"), this.densEl), el("div", { class: "metric" }, el("span", {}, "🔮 Predict"), this.predictEl), this.dropBtn, this.coachEl);
        this.updateReadout();
    }
    updateReadout() {
