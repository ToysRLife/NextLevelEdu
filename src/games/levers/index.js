...
class Levers {
    constructor(ctx) {
        ...
        Object.defineProperty(this, "effortDist", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: 3
        }); // distance units right of pivot (player-controlled)
        ...
        Object.defineProperty(this, "distEl", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        });
        Object.defineProperty(this, "torqueEl", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
    ...
    buildPanel() {
        const closer = el("button", { class: "btn secondary", onclick: () => this.nudge(-1) }, "◀ Move closer");
        const farther = el("button", { class: "btn secondary", onclick: () => this.nudge(1) }, "Move farther ▶");
        const checkBtn = el("button", { class: "btn", style: { background: "var(--accent-purple)" }, onclick: () => this.check() }, "⚖️ Check balance");
        ...
        this.ctx.panel.append(el("div", { class: "metric", style: { background: "#1e293b", color: "#fff" } }, el("span", {}, "🎯 Goal"), el("span", {}, "Balance the beam")), el("div", { class: "control-label", style: { marginTop: "8px" } }, "Move your weight"), el("div", { class: "chip-row" }, closer, farther), checkBtn, el("div", { class: "metric" }, el("span", {}, "📏 Your distance"), this.distEl), el("div", { class: "metric" }, el("span", {}, "🔄 Turning effort"), this.torqueEl), el("div", { class: "metric" }, el("span", {}, "🏁 Progress"), this.statusEl), this.coachEl);
        this.updateReadout();
    }
    nudge(d) {
        if (this.ended)
    ...
    win() {
        ...
        this.ctx.services.outcome.succeed({
            message: "Perfectly balanced! A lever multiplies effort: a weight far from the pivot balances a heavier one close to it. That's how a small push can lift a lot.",
            stars,
            resources: { Alloy: 40 },
        });
    }
    ...
    drawWeight(c, x, weight, color, label) {
