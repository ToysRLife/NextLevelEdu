...
class MixItUp implements GameInstance {
  ...
  private win(): void {
    ...
    this.ctx.services.outcome.succeed({
      message:
        "Mix master! A mixture's parts stay themselves, so you can separate them again. Cooking and burning make new substances you can't un-make.",
      stars,
