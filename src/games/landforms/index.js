...
class Landforms {
    ...
    buildPanel() {
        ...
        this.ctx.panel.append(el("div", { class: "metric", style: { background: "#1e293b", color: "#fff" } }, el("span", {}, "🎯 Goal"), el("span", {}, "Name every landform")), el("div", { class: "control-label", style: { marginTop: "8px" } }, "Which landform is it?"), chips, el("div", { class: "metric" }, el("span", {}, "🗺️ Landform"), this.progressEl), this.coachEl);
    }
    choose(name) {
        if (this.ended)
            return;
    ...
    win() {
        ...
        this.ctx.services.outcome.succeed({
            message: "Master mapmaker! Landforms are the Earth's natural shapes — mountains, valleys, rivers, islands, lakes, and plateaus.",
            stars,
            resources: { Rock: 40 },
        });
    }
