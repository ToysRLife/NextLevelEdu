...
class BodiesOfWater {
    ...
    buildPanel() {
        ...
        this.ctx.panel.append(el("div", { class: "metric", style: { background: "#1e293b", color: "#fff" } }, el("span", {}, "🎯 Goal"), el("span", {}, "Name every water")), el("div", { class: "control-label", style: { marginTop: "8px" } }, "What is it?"), chips, el("div", { class: "metric" }, el("span", {}, "💧 Picture"), this.progressEl), this.coachEl);
    }
    choose(name) {
        if (this.ended)
            return;
        ...
        if (this.idx >= this.order.length) {
            ...
            this.progressEl.textContent = `${this.idx + 1} / ${BODIES.length}`;
    }
    win() {
        this.ended = true;
...
export const bodiesOfWaterGame = {
    meta: {
        id: "bodiesofwater",
        conceptId: "ess-12",
        title: "Water World",
