...
//   { uid, email, name, time }
export const SIGNUP_NOTIFY_URL = "https://script.google.com/macros/s/AKfycbye3uyjm8uvgKdJ1rtCs3uX1czXwDMiEi1RTItkqwQ0D26ne1B_QDD7D4kwcfGBacHFew/exec";
...
export const ADMIN_EMAILS = ["rhythum1987@gmail.com"];
...
export const isCloudConfigured = () => !!FIREBASE_CONFIG.apiKey;
