...
class Volcano {
    constructor(ctx) {
        ...
        Object.defineProperty(this, "bandLo", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        });
        Object.defineProperty(this, "bandHi", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        ...
        Object.defineProperty(this, "erupting", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: 0
        }); // animation timer for lava burst
        ...
        Object.defineProperty(this, "cone", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: 0
        }); // grows with each good eruption
        ...
        Object.defineProperty(this, "lava", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: []
        });
        Object.defineProperty(this, "pressEl", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
    ...
    buildPanel() {
        const eruptBtn = el("button", { class: "btn", style: { background: "var(--accent-red)" }, onclick: () => this.erupt() }, "🌋 Erupt");
        const steamBtn = el("button", { class: "btn secondary", onclick: () => this.releaseSteam() }, "💨 Release Steam");
        ...
        this.ctx.panel.append(el("div", { class: "metric", style: { background: "#1e293b", color: "#fff" } }, el("span", {}, "🎯 Goal"), el("span", {}, `${NEED} controlled eruptions`)), el("div", { class: "control-label", style: { marginTop: "8px" } }, "Erupt in the green band"), eruptBtn, steamBtn, el("div", { class: "metric" }, el("span", {}, "🌡️ Pressure"), this.pressEl), el("div", { class: "metric" }, el("span", {}, "🏔️ Eruptions"), this.statusEl), this.coachEl);
    }
    erupt() {
        if (this.ended)
            return;
    ...
    tick(dtMs) {
        ...
        if (this.erupting > 0)
            this.erupting = Math.max(0, this.erupting - 0.02 * f);
    ...
    finish() {
        ...
        this.ctx.services.outcome.succeed({
            message: "A new mountain! Volcanoes erupt when magma and gas build pressure. Each lava flow cools into solid rock, slowly building the land.",
            stars,
            resources: { Rock: 40 },
        });
    }
