...
const SAFE_BY_TIER = { junior: 3.0, explorer: 2.2, master: 1.6 };
const FUEL_BY_TIER = { junior: 130, explorer: 100, master: 80 };
class Lander {
    constructor(ctx) {
        ...
        Object.defineProperty(this, "safeSpeed", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        });
        Object.defineProperty(this, "startFuel", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        ...
        Object.defineProperty(this, "thrusting", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: false
        ...
        Object.defineProperty(this, "crashes", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: 0
        });
        Object.defineProperty(this, "flameAnim", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: 0
        ...
        Object.defineProperty(this, "resting", {
            ...
            writable: true,
            value: false
        }); // sitting on pad between landings
        ...
        Object.defineProperty(this, "fuelEl", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
    ...
    buildPanel() {
        const thrustBtn = el("button", { class: "btn", style: { background: "var(--accent-orange)" } }, "🔥 Hold to thrust");
        ...
        this.ctx.panel.append(el("div", { class: "metric", style: { background: "#1e293b", color: "#fff" } }, el("span", {}, "🎯 Goal"), el("span", {}, `Land softly ${NEED}×`)), el("div", { class: "control-label", style: { marginTop: "8px" } }, "Fight gravity with thrust"), thrustBtn, el("div", { class: "metric" }, el("span", {}, "⬇️ Fall speed"), this.speedEl), el("div", { class: "metric" }, el("span", {}, "⛽ Fuel"), this.fuelEl), el("div", { class: "metric" }, el("span", {}, "🚀 Landings"), this.statusEl), this.coachEl);
    }
    resetLander() {
        this.y = 120;
        this.vy = 0;
    ...
    win() {
        ...
        this.ctx.services.outcome.succeed({
            message: "Smooth landings! Gravity pulls everything downward, speeding things up as they fall. Thrust pushes back, so short bursts let you touch down gently.",
            stars,
            resources: { Fuel: 40 },
        });
    }
    render() {
        ...
        for (let i = 0; i < 50; i++)
            c.fillRect((i * 151) % W, (i * 53) % 460, 2, 2);
        // moon ground + pad
        c.fillStyle = "#475569";
