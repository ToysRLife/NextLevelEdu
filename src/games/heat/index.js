...
class Heat {
    constructor(ctx) {
        ...
        Object.defineProperty(this, "cold", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: 2
        });
        Object.defineProperty(this, "shownTemp", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: 20
        }); // animated thermometer reading
        ...
        Object.defineProperty(this, "resultEl", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
    ...
    buildPanel() {
        const hotSlider = el("input", {
            ...
            oninput: (e) => {
                this.hot = Number(e.target.value);
                this.updateReadout();
            },
        });
        const coldSlider = el("input", {
            ...
            oninput: (e) => {
                this.cold = Number(e.target.value);
                this.updateReadout();
            },
        });
        const checkBtn = el("button", { class: "btn", style: { background: "var(--accent-orange)" }, onclick: () => this.check() }, "🌡️ Pour & check");
        ...
        this.ctx.panel.append(el("div", { class: "metric", style: { background: "#1e293b", color: "#fff" } }, el("span", {}, "🎯 Make"), el("span", {}, `${this.target().temp}° — ${this.target().label}`)), el("div", { class: "control-label", style: { marginTop: "8px" } }, "🔥 Hot water cups (90°)"), hotSlider, el("div", { class: "control-label" }, "🧊 Cold water cups (10°)"), coldSlider, checkBtn, el("div", { class: "metric" }, el("span", {}, "🌡️ Mix temp"), this.resultEl), el("div", { class: "metric" }, el("span", {}, "✅ Matched"), this.statusEl), this.coachEl);
        this.updateReadout();
    }
    updateReadout() {
        const r = this.result();
    ...
    win() {
        ...
        this.ctx.services.outcome.succeed({
            message: "Just right! Mixing hot and cold water gives a temperature in between — the more you add of one, the closer the mix moves to it. That's heat sharing out evenly.",
            stars,
            resources: { Fuel: 40 },
        });
    }
    ...
    drawJug(c, x, emoji, color, cups, label) {
        c.fillStyle = "rgba(255,255,255,0.5)";
