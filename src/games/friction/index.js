...
class Friction {
    constructor(ctx) {
        ...
        Object.defineProperty(this, "launchSpeed", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: 9
        ...
        Object.defineProperty(this, "targetW", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
    ...
    buildPanel() {
        const surfRow = el("div", { class: "chip-row" }, ...SURFACES.map((s) => el("button", {
            class: "chip",
            style: this.surface.key === s.key
                ? {
        ...
        this.goBtn = el("button", { class: "btn", style: { background: "var(--accent-green)" }, onclick: () => this.launch() }, "🛷 Push the sled");
        ...
        this.ctx.panel.append(el("div", { class: "metric", style: { background: "#1e293b", color: "#fff" } }, el("span", {}, "🎯 Goal"), el("span", {}, `Stop on ${NEED} targets`)), el("div", { class: "control-label", style: { marginTop: "8px" } }, "Pick the sliding surface"), surfRow, this.goBtn, el("div", { class: "metric" }, el("span", {}, "🎯 Landed on target"), this.statusEl), this.coachEl);
    }
    launch() {
        if (this.ended || this.sliding)
            return;
        this.x = START_X;
    ...
    finish() {
        ...
        this.ctx.services.outcome.succeed({
            message: "Nailed it! Friction is the force that slows sliding things. Rough surfaces grip more and stop things fast; smooth ones let them glide far.",
            stars,
            resources: { Oxygen: 40 },
        });
    }
