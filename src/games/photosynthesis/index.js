...
class Photosynthesis {
    constructor(ctx) {
        ...
        Object.defineProperty(this, "waterFactor", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        ...
        Object.defineProperty(this, "state", {
            ...
            configurable: true,
            writable: true,
            value: { water: 100, storedCO2: 0, glucose: 0, aperture: 0.5 }
        });
        // panel elements we update each tick
        Object.defineProperty(this, "h2oEl", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        });
        Object.defineProperty(this, "glucoseEl", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        ...
        Object.defineProperty(this, "envEl", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        });
        Object.defineProperty(this, "canvasBg", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        });
        Object.defineProperty(this, "weatherChips", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        ...
        this.canvasBg = ctx.canvas.parentElement;
        this.buildPanel();
    ...
    buildPanel() {
        const slider = el("input", {
            ...
            oninput: (e) => {
                this.state.aperture = Number(e.target.value) / 100;
                this.updateReadout();
            },
        });
        const chips = el("div", { class: "chip-row" }, ...WEATHER.map((w) => el("button", {
        ...
        this.ctx.panel.append(el("div", { class: "control-label" }, "Stomata Opening (Throttle)"), slider, el("div", { class: "control-label", style: { marginTop: "8px" } }, "Weather"), chips, this.envEl, el("div", { class: "metric" }, el("span", {}, "💧 Water"), this.h2oEl), el("div", { class: "metric" }, el("span", {}, "⚡ Glucose"), this.glucoseEl), this.coachEl);
    }
    applyWeather(w) {
        this.weather = w;
    ...
    updateReadout() {
        ...
        this.envEl.replaceChildren(el("span", { style: { color: "#fca5a5" } }, `${this.weather.temp}°C`), el("span", { style: { color: "#7dd3fc" } }, `${Math.round(this.weather.humidity * 100)}% Hum`), el("span", { style: { color: "#fde047" } }, `${Math.round(this.weather.sunlight * 100)}% Sun`));
    ...
    coachText() {
        ...
        if (ap > 0.8)
            return "🌿 Maximizing CO₂ — great growth, but watch your water.";
        if (ap < 0.2)
            return "🏜️ Conserving water, but glucose production has stalled.";
    ...
    tick(dtMs) {
        ...
        this.updateReadout();
        this.render();
        if (this.state.glucose >= 100)
            this.win();
        else if (this.state.water <= 0)
            this.lose();
    }
    win() {
        this.ended = true;
...
export const photosynthesisGame = {
    meta: {
        id: "photosynthesis",
        conceptId: "bio-07",
        title: "Stomata Squad",
