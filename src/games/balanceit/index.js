...
class BalanceIt {
    constructor(ctx) {
        ...
        Object.defineProperty(this, "coeffs", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: []
        });
        Object.defineProperty(this, "ctls", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: []
        });
        Object.defineProperty(this, "tallyEl", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
    ...
    buildPanel() {
        ...
        this.ctx.panel.append(el("div", { class: "metric", style: { background: "#1e293b", color: "#fff" } }, el("span", {}, "⚖️ Balance"), el("span", {}, this.equationText())), ...this.ctls.map((c) => c.el), this.tallyEl, el("button", { class: "btn", style: { background: "var(--accent-blue)" }, onclick: () => this.check() }, "⚖️ Check balance"), el("div", { class: "metric" }, el("span", {}, "✅ Balanced"), this.statusEl), this.coachEl);
        this.updateTally();
    }
    equationText() {
        const r = this.eq()
    ...
    win() {
        ...
        this.ctx.services.outcome.succeed({
            message: "Balanced! Atoms are never created or destroyed in a reaction — only rearranged. That's why a balanced equation has the same count of every atom on both sides.",
            stars,
