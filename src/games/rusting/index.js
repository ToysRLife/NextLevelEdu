...
class Rusting {
    constructor(ctx) {
        ...
        Object.defineProperty(this, "rust", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: 0
        ...
        Object.defineProperty(this, "coating", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: 0
        ...
        Object.defineProperty(this, "rainTimer", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: 0
        });
        Object.defineProperty(this, "rainOn", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: false
        });
        Object.defineProperty(this, "rainDrops", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: []
        });
        Object.defineProperty(this, "rustEl", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        });
        Object.defineProperty(this, "timeEl", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        });
        Object.defineProperty(this, "waterEl", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
    ...
    buildPanel() {
        const coatBtn = el("button", {
            class: "btn",
            style: { background: "var(--accent-blue)" },
            onclick: () => this.applyCoating(),
        }, "🛢️ Apply coating");
        const dryBtn = el("button", { class: "btn secondary", onclick: () => this.wipeDry() }, "🧽 Wipe dry");
        ...
        this.ctx.panel.append(el("div", { class: "metric", style: { background: "#1e293b", color: "#fff" } }, el("span", {}, "🎯 Goal"), el("span", {}, `Survive ${SURVIVE}s rust-free`)), el("div", { class: "control-label", style: { marginTop: "8px" } }, "Keep water & air off the iron"), coatBtn, dryBtn, el("div", { class: "metric" }, el("span", {}, "🦠 Rust"), this.rustEl), el("div", { class: "metric" }, el("span", {}, "💧 Wetness"), this.waterEl), el("div", { class: "metric" }, el("span", {}, "⏱️ Time left"), this.timeEl), this.coachEl);
    }
    applyCoating() {
        if (this.ended)
            return;
    ...
    tick(dtMs) {
        ...
        if (this.rainTimer <= 0) {
            ...
            if (this.rainOn && Math.random() < 0.4)
                this.salt = Math.min(1, this.salt + 0.5);
        }
        if (this.rainOn) {
    ...
    win() {
        ...
        this.ctx.services.outcome.succeed({
            message: "The bridge stands strong! Rust needs both water and air — keeping iron dry or sealing it with a coating stops the metal from corroding.",
            stars,
            resources: { Energy: 40 },
        });
    }
    fail() {
        ...
        this.ctx.services.outcome.fail({
            message: "The bridge rusted through! Left wet and exposed to air, iron keeps corroding — especially with salt. Dry it or seal it sooner next time.",
            stars: 0,
        });
    }
    render() {
