...
class Camouflage {
    constructor(ctx) {
        ...
        Object.defineProperty(this, "scan", {
            ...
            writable: true,
            value: 0
        }); // predator scan progress 0..1
        Object.defineProperty(this, "spotted", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: 0
        ...
        Object.defineProperty(this, "safeFlash", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: 0
        });
        Object.defineProperty(this, "matchEl", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
    ...
    buildPanel() {
        ...
        const lightSlider = el("input", {
            ...
            oninput: (e) => {
                this.light = Number(e.target.value);
                this.updateReadout();
            },
        });
        ...
        this.ctx.panel.append(el("div", { class: "metric", style: { background: "#1e293b", color: "#fff" } }, el("span", {}, "🎯 Goal"), el("span", {}, `Hide from ${NEED} predators`)), el("div", { class: "control-label", style: { marginTop: "8px" } }, "🎨 Colour"), hueSlider, el("div", { class: "control-label" }, "☀️ Light / dark"), lightSlider, el("div", { class: "metric" }, el("span", {}, "🫥 Blend"), this.matchEl), el("div", { class: "metric" }, el("span", {}, "🏆 Survived"), this.statusEl), this.coachEl);
        this.updateReadout();
    }
    updateReadout() {
    ...
    tick(dtMs) {
        ...
        const f = dtMs / 16.67;
        if (this.safeFlash > 0)
            this.safeFlash = Math.max(0, this.safeFlash - 0.02 * f);
        this.scan += 0.006 * f;
        if (this.scan >= 1) {
            this.scan = 0;
            this.evaluate();
    ...
    finish() {
        ...
        this.ctx.services.outcome.succeed({
            message: "You vanished! Camouflage lets animals match their surroundings — colour and brightness — so predators can't tell them apart from the background.",
            stars,
