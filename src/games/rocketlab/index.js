...
class RocketLab {
    constructor(ctx) {
        ...
        Object.defineProperty(this, "launching", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: false
        ...
        Object.defineProperty(this, "rocketY", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: PAD_Y
        ...
        Object.defineProperty(this, "thrustCtl", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        ...
        Object.defineProperty(this, "aRead", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        });
        Object.defineProperty(this, "vRead", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
    ...
    buildPanel() {
        ...
        this.launchBtn = el("button", { class: "btn", style: { background: "var(--accent-green)" }, onclick: () => this.launch() }, "🚀 Launch");
        clear(this.ctx.panel);
        this.ctx.panel.append(el("div", { class: "metric", style: { background: "#1e293b", color: "#fff" } }, el("span", {}, "🎯 Mission"), el("span", {}, `Reach ${this.round().targetV} m/s in ${this.round().burn}s`)), this.thrustCtl.el, this.massCtl.el, this.aRead.el, this.vRead.el, this.launchBtn, el("div", { class: "metric" }, el("span", {}, "✅ Launches nailed"), this.statusEl), this.coachEl);
        this.updatePrediction();
    }
    updatePrediction() {
        const a = this.accel();
    ...
    finish() {
        ...
        this.ctx.services.outcome.succeed({
            message: "Mission control! You used Newton's 2nd law — acceleration = force ÷ mass — to engineer every launch. More thrust or less mass = more acceleration.",
            stars,
            resources: { Fuel: 60 },
        });
    }
