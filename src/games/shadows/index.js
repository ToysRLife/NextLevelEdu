...
class Shadows {
    constructor(ctx) {
        ...
        Object.defineProperty(this, "lightX", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: 120
        }); // 60..400
        Object.defineProperty(this, "targetH", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: 200
        ...
        Object.defineProperty(this, "tol", {
            ...
            writable: true,
            value: void 0
        }); // shadow-match tolerance (adaptive)
    ...
    buildPanel() {
        const slider = el("input", {
            ...
            oninput: (e) => {
                this.lightX = Number(e.target.value);
                this.updateReadout();
            },
        });
        this.sizeEl = el("span", {}, "");
        ...
        this.ctx.panel.append(el("div", { class: "metric", style: { background: "#1e293b", color: "#fff" } }, el("span", {}, "🎯 Goal"), el("span", {}, `Match ${NEED} shadows`)), el("div", { class: "control-label", style: { marginTop: "8px" } }, "💡 Lamp distance (near → far)"), slider, el("div", { class: "metric" }, el("span", {}, "🌑 Shadow"), this.sizeEl), el("div", { class: "metric" }, el("span", {}, "✅ Matched"), this.statusEl), this.coachEl);
        this.updateReadout();
    }
    updateReadout() {
    ...
    win() {
        ...
        this.ctx.services.outcome.succeed({
            message: "Shadow master! Light travels in straight lines, so an object blocks it and casts a shadow. A closer light makes a bigger shadow; a farther light makes a smaller one.",
            stars,
            resources: { Oxygen: 40 },
        });
    }
