...
class Energy {
    constructor(ctx) {
        ...
        Object.defineProperty(this, "charge", {
            ...
            writable: true,
            value: 40
        }); // 0..100 stored (potential) energy from pulling back
        ...
        Object.defineProperty(this, "launchE", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: 1
        }); // total mechanical energy at launch (for bar scaling)
        ...
        Object.defineProperty(this, "chargeEl", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
    ...
    buildPanel() {
        const chargeSlider = el("input", {
            ...
            oninput: (e) => {
                if (this.flying)
                    return;
                this.charge = Number(e.target.value);
                this.updateReadout();
            },
        });
        this.launchBtn = el("button", { class: "btn", style: { background: "var(--accent-orange)" }, onclick: () => this.launch() }, "🚀 Release!");
        ...
        this.ctx.panel.append(el("div", { class: "metric", style: { background: "#1e293b", color: "#fff" } }, el("span", {}, "🎯 Goal"), el("span", {}, `Hit ${NEED} targets`)), el("div", { class: "control-label", style: { marginTop: "8px" } }, "💪 Pull back (stored energy)"), chargeSlider, this.launchBtn, el("div", { class: "metric" }, el("span", {}, "🔋 Stored"), this.chargeEl), el("div", { class: "metric" }, el("span", {}, "🎯 Hits"), this.statusEl), this.coachEl);
        this.updateReadout();
    }
    updateReadout() {
    ...
    finish() {
        ...
        this.ctx.services.outcome.succeed({
            message: "Bullseye! Stored (potential) energy in the pulled-back arm became kinetic energy of motion — and in flight the two kept trading back and forth.",
            stars,
            resources: { Fuel: 40 },
        });
    }
