...
class Weathering {
    constructor(ctx) {
        ...
        Object.defineProperty(this, "debris", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: []
    ...
    buildPanel() {
        const palette = el("div", { class: "chip-row" }, ...AGENTS.map((a) => el("button", {
            class: "chip",
            style: this.active === a.key
                ? {
        ...
        this.ctx.panel.append(el("div", { class: "metric", style: { background: "#1e293b", color: "#fff" } }, el("span", {}, "🎯 Goal"), el("span", {}, "Carve the target shape")), el("div", { class: "control-label", style: { marginTop: "8px" } }, "Choose an erosion force"), palette, el("div", { class: "metric" }, el("span", {}, "🪨 Shape match"), this.matchEl), this.coachEl);
    }
    erode(p) {
        if (this.ended)
            return;
    ...
    renderLoop() {
        const draw = () => {
            ...
            if (this.matchEl)
                this.matchEl.textContent = `${Math.round(pct * 100)}%`;
    ...
    finish() {
        ...
        this.ctx.services.outcome.succeed({
            message: "The landscape is shaped! Weathering and erosion — by water, wind, and ice — slowly wear rock away, carving valleys, hills, and canyons over a very long time.",
            stars,
            resources: { Rock: 40 },
        });
    }
