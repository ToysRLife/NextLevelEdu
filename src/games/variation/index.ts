...
class Variation implements GameInstance {
  ...
  private buildPanel(): void {
    ...
    this.ctx.panel.append(
      el(
        ...
        el("span", {}, "👉 Find"),
        el("span", {}, this.current().prompt)
      ),
      el(
        "div",
        { class: "control-label", style: { marginTop: "8px" } },
        "Tap it among the puppies"
      ),
  ...
  private win(): void {
    ...
    this.ctx.services.outcome.succeed({
      message:
        "Spot on! Living things of the same kind still vary — different sizes, colours, and markings. That variation makes every individual unique.",
      stars,
