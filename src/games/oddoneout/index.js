...
class OddOneOut {
    ...
    buildPanel() {
        ...
        this.ctx.panel.append(el("div", { class: "metric", style: { background: "#1e293b", color: "#fff" } }, el("span", {}, "🎯 Compare by"), el("span", {}, this.current().property)), el("div", { class: "control-label", style: { marginTop: "8px" } }, "Tap the odd one out on the board"), el("div", { class: "metric" }, el("span", {}, "🧩 Puzzle"), this.progressEl), this.coachEl);
    }
    tap(p) {
        if (this.ended)
            return;
    ...
    win() {
        ...
        this.ctx.services.outcome.succeed({
            message: "Sharp eyes! Objects have properties — colour, shape, material, texture — and we can group and compare things by them.",
            stars,
