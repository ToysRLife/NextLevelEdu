...
export function renderLoginGate(root) {
    const c = cloud();
    const card = el("div", { class: "login-card" }, el("div", { class: "login-hero" }, "🚀"), el("h1", { class: "login-title" }, "NextLevel ", el("span", {}, "Edu")), el("p", { class: "login-sub" }, `Play ${GAME_MANIFESTS.length} science adventures, build your own worlds, and collect trophies.`), el("p", { class: "login-note-lead" }, "Sign in to start — your progress follows you to every device."));
    if (c.needsName) {
