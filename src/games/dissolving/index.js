...
class Dissolving {
    constructor(ctx) {
        ...
        Object.defineProperty(this, "targetSpoons", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        }); // spoons to fully dissolve (adaptive)
        Object.defineProperty(this, "spoons", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: 0
        }); // total added
        Object.defineProperty(this, "dissolved", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: 0
        ...
        Object.defineProperty(this, "stir", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: 0
        });
        Object.defineProperty(this, "swirl", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: 0
        ...
        Object.defineProperty(this, "spoonsEl", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        });
        Object.defineProperty(this, "dissEl", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        });
        Object.defineProperty(this, "capEl", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
    ...
    buildPanel() {
        ...
        this.ctx.panel.append(el("div", { class: "metric", style: { background: "#1e293b", color: "#fff" } }, el("span", {}, "🎯 Goal"), el("span", {}, `Dissolve ${this.targetSpoons} spoons`)), this.addBtn, el("div", { class: "control-label", style: { marginTop: "8px" } }, "🌡️ Temperature"), tempSlider, stirBtn, el("div", { class: "metric" }, el("span", {}, "🥄 Spoons added"), this.spoonsEl), el("div", { class: "metric" }, el("span", {}, "💧 Dissolved"), this.dissEl), el("div", { class: "metric" }, el("span", {}, "🫙 Can hold"), this.capEl), this.coachEl);
        this.updateReadout();
    }
    updateReadout() {
    ...
    finish() {
        ...
        this.ctx.services.outcome.succeed({
            message: "Clear solution! The sugar dissolved — its tiny particles spread evenly through the water. Heat and stirring sped it up.",
            stars,
