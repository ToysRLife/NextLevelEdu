...
class ClimateWeather implements GameInstance {
  ...
  private buildPanel(): void {
    ...
    this.ctx.panel.append(
      el(
        ...
        el("span", {}, "🌦️ Statement"),
        el("span", {}, `${this.idx + 1}/${STATEMENTS.length}`)
      ),
  ...
  private win(): void {
    ...
    this.ctx.services.outcome.succeed({
      message:
        "Got it! Weather is what's happening now; climate is the usual weather of a place over many years.",
      stars,
