...
function mix(r, y, b) {
    const trans = (amt, base) => 1 - amt * (1 - base);
...
class ColorMix {
    ...
    buildPanel() {
        const checkBtn = el("button", { class: "btn", style: { background: "var(--accent-pink)" }, onclick: () => this.check() }, "🎨 Check color");
        ...
        this.ctx.panel.append(el("div", { class: "metric", style: { background: "#1e293b", color: "#fff" } }, el("span", {}, "🎯 Make"), el("span", {}, this.target().name)), this.slider("🔴 Red paint", "#ef4444", () => this.r, (v) => (this.r = v)), this.slider("🟡 Yellow paint", "#eab308", () => this.y, (v) => (this.y = v)), this.slider("🔵 Blue paint", "#3b82f6", () => this.b, (v) => (this.b = v)), checkBtn, el("div", { class: "metric" }, el("span", {}, "🎯 Match"), this.matchEl), el("div", { class: "metric" }, el("span", {}, "✅ Done"), this.statusEl), this.coachEl);
        this.updateReadout();
    }
    updateReadout() {
    ...
    win() {
        ...
        this.ctx.services.outcome.succeed({
            message: "You're a color wizard! Mixing the primary paints — red, yellow, and blue — makes brand-new colors: orange, green, and purple.",
            stars,
