            ...
            : pH < 7.5
                ...
                : pH < 9
                    ...
                    : pH < 11.5
                        ? "#3b82f6"
                        : "#7c3aed";
const ROUNDS = [12, 7, 2]; // target pH values
class PhMixer {
    constructor(ctx) {
        ...
        Object.defineProperty(this, "acidVol", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: 0
        ...
        Object.defineProperty(this, "acidCtl", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        });
        Object.defineProperty(this, "phRead", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
    ...
    buildPanel() {
        ...
        this.ctx.panel.append(el("div", { class: "metric", style: { background: "#1e293b", color: "#fff" } }, el("span", {}, "🎯 Target pH"), el("span", {}, `${this.target()}`)), el("div", { class: "metric" }, el("span", {}, "🧫 Starting base"), el("span", {}, `${BASE_VOL} mL · pH ${pHfor(0).toFixed(1)}`)), this.acidCtl.el, this.phRead.el, el("button", { class: "btn", style: { background: "var(--accent-red)" }, onclick: () => this.check() }, "🌈 Test the pH"), el("div", { class: "metric" }, el("span", {}, "✅ pH targets hit"), this.statusEl), this.coachEl);
        this.updateReadout();
    }
    updateReadout() {
    ...
    win() {
        ...
        this.ctx.services.outcome.succeed({
            message: "pH pro! Acids have a low pH, bases a high pH, and mixing them neutralizes toward 7. The universal indicator shows it as a rainbow from red (acid) to purple (base).",
            stars,
    ...
    render() {
        ...
        for (const v of [0, 7, 14])
            c.fillText(String(v), 120 + v * 40 + 19, 152);
