...
class Ramp {
    constructor(ctx) {
        ...
        Object.defineProperty(this, "pushing", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: false
        ...
        Object.defineProperty(this, "forceEl", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        });
        Object.defineProperty(this, "angleEl", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        });
        Object.defineProperty(this, "formulaEl", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
    ...
    buildPanel() {
        const slider = el("input", {
            ...
            oninput: (e) => {
                if (this.pushing)
                    return;
                this.angleDeg = Number(e.target.value);
                this.updateReadout();
            },
        });
        const pushBtn = el("button", { class: "btn", style: { background: "var(--accent-green)" }, onclick: () => this.push() }, "💪 Push it up");
        ...
        this.ctx.panel.append(el("div", { class: "metric", style: { background: "#1e293b", color: "#fff" } }, el("span", {}, "🎯 Goal"), el("span", {}, "Get the crate up")), el("div", { class: "control-label", style: { marginTop: "8px" } }, "📐 Ramp steepness"), slider, el("div", { class: "metric" }, el("span", {}, "📐 Ramp angle"), this.angleEl), pushBtn, el("div", { class: "control-label", style: { marginTop: "8px" } }, "🧮 Force = weight × sin(angle)"), el("div", { class: "metric" }, el("span", {}, "Your crate"), this.formulaEl), el("div", { class: "metric" }, el("span", {}, "💪 Force needed"), this.forceEl), el("div", { class: "metric" }, el("span", {}, "📦 Crates moved"), this.statusEl), this.coachEl);
        this.updateReadout();
    }
    updateReadout() {
        const r = this.round();
    ...
    finish() {
        ...
        this.ctx.services.outcome.succeed({
            message: "Loaded up! A ramp is a simple machine: the gentler the slope, the less force you need — though you push over a longer distance. Less effort, more distance.",
            stars,
            resources: { Alloy: 40 },
        });
    }
