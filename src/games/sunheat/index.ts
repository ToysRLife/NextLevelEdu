...
class SunHeat implements GameInstance {
  ...
  private buildPanel(): void {
    ...
    this.ctx.panel.append(
      el(
        ...
        el("span", {}, "☀️ Does the Sun…"),
        el("span", {}, `${this.idx + 1}/${CLAIMS.length}`)
      ),
  ...
  private win(): void {
    ...
    this.ctx.services.outcome.succeed({
      message:
        "Bright thinking! The Sun gives Earth light and heat — lighting the day, warming the world, and helping plants grow.",
      stars,
