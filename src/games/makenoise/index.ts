...
class MakeNoise implements GameInstance {
  ...
  private buildPanel(): void {
    ...
    this.ctx.panel.append(
      el(
        ...
        el("span", {}, "🎯 Goal"),
        el("span", {}, "Make them all sing")
      ),
      el(
        "div",
        { class: "control-label", style: { marginTop: "8px" } },
        "Tap the instruments on screen"
      ),
  ...
  private win(): void {
    ...
    this.ctx.services.outcome.succeed({
      message:
        "What a band! Every sound is made by something vibrating fast. No vibration means no sound.",
      stars,
      resources: { Fuel: 40 },
    });
  }
