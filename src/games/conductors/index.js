...
class Conductors {
    constructor(ctx) {
        ...
        Object.defineProperty(this, "lit", {
            ...
            writable: true,
            value: 0
        }); // bulb glow 0..1 for current item if conductor (after answer)
    ...
    buildPanel() {
        ...
        }, "⚡ Conducts"), el("button", { class: "btn secondary", onclick: () => this.guess(false) }, "🚫 Blocks it"));
        ...
        this.ctx.panel.append(el("div", { class: "metric", style: { background: "#1e293b", color: "#fff" } }, el("span", {}, "🔋 Test in the gap"), el("span", {}, this.current().name)), el("div", { class: "control-label", style: { marginTop: "8px" } }, "Conductor or insulator?"), choices, el("div", { class: "metric" }, el("span", {}, "🧪 Material"), this.progressEl), this.coachEl);
    }
    guess(saysConducts) {
    ...
    win() {
        ...
        this.ctx.services.outcome.succeed({
            message: "Circuit complete! Conductors (mostly metals) let electricity flow; insulators (wood, plastic, rubber, glass) block it. That's why wires are metal wrapped in plastic.",
            stars,
            resources: { Power: 40 },
        });
    }
