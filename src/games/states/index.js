...
class States {
    constructor(ctx) {
        ...
        Object.defineProperty(this, "tempEl", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        ...
        const targets = ["liquid", "gas", "solid"];
    ...
    buildPanel() {
        const slider = el("input", {
            ...
            oninput: (e) => {
                this.temp = Number(e.target.value);
                this.updateReadout();
            },
        });
        ...
        this.ctx.panel.append(el("div", { class: "metric", style: { background: "#1e293b", color: "#fff" } }, el("span", {}, "🎯 Target"), el("span", {}, `${info.emoji} ${info.label}`)), el("div", { class: "control-label", style: { marginTop: "8px" } }, "❄️ Cool  ←→  Heat 🔥"), slider, el("div", { class: "metric" }, el("span", {}, "🌡️ Temp"), this.tempEl), el("div", { class: "metric" }, el("span", {}, "🔬 State"), this.stateEl), this.coachEl);
        this.updateReadout();
    }
    updateReadout() {
        const st = this.state();
