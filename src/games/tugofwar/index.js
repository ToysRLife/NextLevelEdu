...
class TugOfWar {
    constructor(ctx) {
        ...
        Object.defineProperty(this, "netEl", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
    ...
    buildPanel() {
        const blue = el("input", {
            ...
            oninput: (e) => {
                this.left = Number(e.target.value);
                this.updateReadout();
            },
        });
        const red = el("input", {
            ...
            oninput: (e) => {
                this.right = Number(e.target.value);
                this.updateReadout();
            },
        });
        this.netEl = el("span", {}, "");
        ...
        this.ctx.panel.append(el("div", { class: "metric", style: { background: "#1e293b", color: "#fff" } }, el("span", {}, "🎯 Goal"), el("span", {}, this.goal().label)), el("div", { class: "control-label", style: { marginTop: "8px" } }, "🔵 Blue pullers"), blue, el("div", { class: "control-label" }, "🔴 Red pullers"), red, el("div", { class: "metric" }, el("span", {}, "⚖️ Forces"), this.netEl), el("div", { class: "metric" }, el("span", {}, "✅ Done"), this.statusEl), this.coachEl);
        this.updateReadout();
    }
    updateReadout() {
    ...
    win() {
        ...
        this.ctx.services.outcome.succeed({
            message: "Force master! Equal forces are balanced — nothing moves. Unequal forces are unbalanced, and the object always moves toward the stronger pull.",
            stars,
            resources: { Power: 40 },
        });
    }
