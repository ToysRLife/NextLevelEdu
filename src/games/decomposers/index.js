...
class Decomposers {
    constructor(ctx) {
        ...
        Object.defineProperty(this, "piles", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: []
        ...
        Object.defineProperty(this, "grown", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: 0
        ...
        Object.defineProperty(this, "nutrientEl", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
    ...
    buildPanel() {
        const palette = el("div", { class: "chip-row" }, ...DECOMPOSERS.map((d) => el("button", {
            class: "chip",
            style: this.active === d.key
                ? {
        ...
        this.ctx.panel.append(el("div", { class: "metric", style: { background: "#1e293b", color: "#fff" } }, el("span", {}, "🎯 Goal"), el("span", {}, "Recycle all 5 piles")), el("div", { class: "control-label", style: { marginTop: "8px" } }, "Pick a decomposer, then tap dead matter"), palette, el("div", { class: "metric" }, el("span", {}, "🌱 New plants"), this.statusEl), el("div", { class: "metric" }, el("span", {}, "🟤 Soil nutrients"), this.nutrientEl), this.coachEl);
    }
    poke(p) {
        if (this.ended)
            return;
    ...
    tick(dtMs) {
        ...
        for (const pile of this.piles) {
            ...
            if (pile.decay >= 1) {
                ...
                if (this.grown >= this.piles.length)
                    this.finish();
            }
    ...
    finish() {
        ...
        this.ctx.services.outcome.succeed({
            message: "The forest renews itself! Decomposers break dead matter into soil nutrients, and new plants grow from them. Nothing is wasted — it's nature's recycling.",
            stars,
