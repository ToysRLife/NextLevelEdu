...
class Maps {
    ...
    buildPanel() {
        ...
        this.ctx.panel.append(el("div", { class: "metric", style: { background: "#1e293b", color: "#fff" } }, el("span", {}, "🗺️ Find the"), el("span", {}, `${this.current().emoji} ${this.current().name}`)), el("div", { class: "control-label", style: { marginTop: "8px" } }, "Tap it on the map"), el("div", { class: "metric" }, el("span", {}, "📍 Place"), this.progressEl), this.coachEl);
    }
    tap(p) {
        if (this.ended)
            return;
