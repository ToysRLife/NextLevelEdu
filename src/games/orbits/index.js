...
class Orbits {
    constructor(ctx) {
        ...
        Object.defineProperty(this, "ecc3Star", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        ...
        Object.defineProperty(this, "speed", {
            ...
            writable: true,
            value: 2.0
        }); // logical units per 60fps-frame
        Object.defineProperty(this, "sat", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: { x: 0, y: 0, vx: 0, vy: 0 }
        });
        ...
        Object.defineProperty(this, "minDist", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: Infinity
        });
        Object.defineProperty(this, "maxDist", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: 0
        });
        Object.defineProperty(this, "sweptAngle", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: 0
        });
        Object.defineProperty(this, "prevAngle", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: 0
    ...
    buildPanel() {
        ...
        this.ctx.panel.append(el("div", { class: "control-label" }, "Launch Speed"), this.slider, el("div", { class: "metric" }, el("span", {}, "🚀 Speed"), this.speedEl), el("div", { class: "metric" }, el("span", {}, "📏 Altitude"), this.distEl), this.launchBtn, this.coachEl);
        this.updateReadout();
    }
    resetCraft() {
    ...
    coachText() {
        if (this.phase === "flying")
            return "🛰️ In flight — let it ride and watch the path it traces.";
    ...
    tick(dtMs) {
        ...
        if (dist < PLANET.r)
            this.crash();
        else if (dist > ESCAPE_DIST)
            this.escape();
        else if (this.sweptAngle >= 2 * Math.PI)
            this.complete();
    }
    complete() {
        this.phase = "ended";
