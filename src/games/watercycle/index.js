...
class WaterCycle {
    constructor(ctx) {
        ...
        Object.defineProperty(this, "vapor", {
            enumerable: true,
            configurable: true,
            writable: true,
        ...
        Object.defineProperty(this, "cloudFill", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: 0
        }); // 0..1
        Object.defineProperty(this, "cloudX", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: 250
        });
        Object.defineProperty(this, "cloudVx", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: 0
        ...
        Object.defineProperty(this, "stageEl", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        });
        Object.defineProperty(this, "cloudEl", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        });
        Object.defineProperty(this, "collectEl", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        ...
        Object.defineProperty(this, "windBtn", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
    ...
    buildPanel() {
        const slider = el("input", {
            ...
            oninput: (e) => {
                this.heat = Number(e.target.value);
            },
        });
        this.windBtn = el("button", {
            class: "btn",
            onclick: () => {
        ...
        this.ctx.panel.append(el("div", { class: "metric", style: { background: "#1e293b", color: "#fff" } }, el("span", {}, "📍 Stage"), this.stageEl), el("div", { class: "control-label", style: { marginTop: "8px" } }, "☀️ Sun Heat"), slider, this.windBtn, el("div", { class: "metric" }, el("span", {}, "☁️ Cloud"), this.cloudEl), el("div", { class: "metric" }, el("span", {}, "💧 Collected"), this.collectEl), this.coachEl);
        this.updateReadout();
    }
    updateReadout() {
    ...
    tick(dtMs) {
        ...
        if ((this.phase === "drift" || this.phase === "evaporate") && this.cloudX > W - 40)
            this.lose();
        this.vapor.update(0.012);
        this.rain.update(0.02);
        // cull rain below ground
        for (let i = this.rain.particles.length - 1; i >= 0; i--) {
            if (this.rain.particles[i].y > SEA_Y)
                this.rain.particles.splice(i, 1);
        }
        this.updateReadout();
        this.render();
    }
