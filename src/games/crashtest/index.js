...
class CrashTest {
    constructor(ctx) {
        ...
        Object.defineProperty(this, "massA", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: 4
        });
        Object.defineProperty(this, "speedA", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: 5
        ...
        Object.defineProperty(this, "wreckX", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: HIT_X
        });
        Object.defineProperty(this, "wreckV", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: 0
        ...
        Object.defineProperty(this, "vfRead", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
    ...
    buildPanel() {
        ...
        this.goBtn = el("button", { class: "btn", style: { background: "var(--accent-red)" }, onclick: () => this.crash() }, "💥 Crash!");
        clear(this.ctx.panel);
        this.ctx.panel.append(el("div", { class: "metric", style: { background: "#1e293b", color: "#fff" } }, el("span", {}, "🎯 Target"), el("span", {}, `Wreck speed ${this.round().targetV} m/s`)), this.massCtl.el, this.speedCtl.el, el("div", { class: "control-label", style: { marginTop: "6px" } }, "🤝 v = (mA × vA) ÷ (mA + mB)"), this.vfRead.el, this.goBtn, el("div", { class: "metric" }, el("span", {}, "✅ Crashes nailed"), this.statusEl), this.coachEl);
        this.updateReadout();
    }
    updateReadout() {
        const r = this.round();
    ...
    finish() {
        ...
        this.ctx.services.outcome.succeed({
            message: "Crash master! Momentum (mass × velocity) is conserved: when carts stick, they share the combined momentum, so the wreck's speed is (mA·vA)/(mA+mB).",
            stars,
            resources: { Fuel: 60 },
        });
    }
