...
class Evaporation {
    constructor(ctx) {
        ...
        Object.defineProperty(this, "vapors", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: []
        });
        Object.defineProperty(this, "droplets", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: 0
        });
        Object.defineProperty(this, "dropPos", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: []
        });
        Object.defineProperty(this, "spawnAcc", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: 0
        ...
        Object.defineProperty(this, "dropEl", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
    ...
    buildPanel() {
        const slider = el("input", {
            ...
            oninput: (e) => {
                this.heat = Number(e.target.value) / 100;
                this.updateReadout();
            },
        });
        ...
        this.ctx.panel.append(el("div", { class: "metric", style: { background: "#1e293b", color: "#fff" } }, el("span", {}, "🎯 Goal"), el("span", {}, `Collect ${this.need} droplets`)), el("div", { class: "control-label", style: { marginTop: "8px" } }, "🔥 Heat"), slider, el("div", { class: "metric" }, el("span", {}, "💧 Droplets on lid"), this.dropEl), this.coachEl);
        this.updateReadout();
    }
    updateReadout() {
        this.coachEl.textContent =
    ...
    finish() {
        ...
        this.ctx.services.outcome.succeed({
            message: "Round trip! Heat evaporated the water into invisible vapour, and touching the cold lid condensed it back into droplets — evaporation and condensation.",
            stars,
            resources: { Energy: 40 },
        });
    }
