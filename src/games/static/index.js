...
class StaticElec {
    constructor(ctx) {
        ...
        Object.defineProperty(this, "bitCount", {
            ...
            writable: true,
            value: void 0
        }); // paper bits to collect (adaptive)
        ...
        Object.defineProperty(this, "lastP", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: null
    ...
    buildPanel() {
        ...
        this.ctx.panel.append(el("div", { class: "metric", style: { background: "#1e293b", color: "#fff" } }, el("span", {}, "🎯 Goal"), el("span", {}, "Collect 8 paper bits")), el("div", { class: "control-label", style: { marginTop: "8px" } }, "Rub on the sweater, then attract the bits"), el("div", { class: "metric" }, el("span", {}, "⚡ Charge"), this.chargeEl), el("div", { class: "metric" }, el("span", {}, "📄 Collected"), this.statusEl), this.coachEl);
    }
    dragMove(p) {
        if (this.ended)
            return;
    ...
    tick(dtMs) {
        ...
        for (const bit of this.bits) {
            ...
            if (d < 26) {
                ...
                if (this.collected >= this.bitCount)
                    this.finish();
            }
        }
    ...
    finish() {
        ...
        this.ctx.services.outcome.succeed({
            message: "Zap! Rubbing moved tiny charges onto the balloon, giving it static electricity — and a charged object pulls on light things like bits of paper.",
            stars,
            resources: { Power: 40 },
        });
    }
