...
class Magnets {
    constructor(ctx) {
        ...
        Object.defineProperty(this, "mag", {
            ...
            configurable: true,
            writable: true,
            value: { x: 160, y: 300, pole: 1 }
        }); // player's magnet; +1 = N showing
        ...
        Object.defineProperty(this, "puck", {
            ...
            configurable: true,
            writable: true,
            value: { x: 400, y: 300, vx: 0, vy: 0, pole: 1 }
        });
        Object.defineProperty(this, "goal", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: { x: 660, y: 300, r: 46 }
        });
        ...
        Object.defineProperty(this, "modeEl", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
    ...
    buildPanel() {
        ...
        this.ctx.panel.append(el("div", { class: "control-label" }, "Drag your magnet on the board"), flipBtn, el("div", { class: "metric" }, el("span", {}, "🧲 Effect"), this.modeEl), el("div", { class: "metric" }, el("span", {}, "⏱️ Time"), this.timeEl), this.coachEl);
        this.updateReadout();
    }
    updateReadout() {
    ...
    attach() {
        this.detach = onPointer(this.ctx.canvas, W, H, {
            down: (p) => {
                if (this.ended)
                    return;
                if (Math.hypot(p.x - this.mag.x, p.y - this.mag.y) < 60)
                    this.dragging = true;
                else
                    this.moveMagnet(p);
            },
    ...
    tick(dtMs) {
        ...
        // goal check
        const inGoal = Math.hypot(this.puck.x - this.goal.x, this.puck.y - this.goal.y) < this.goal.r - 14 &&
            Math.hypot(this.puck.vx, this.puck.vy) < 2.2;
        if (inGoal) {
            this.holdFrames += f;
            if (this.holdFrames >= 45)
                this.win();
        }
        else {
