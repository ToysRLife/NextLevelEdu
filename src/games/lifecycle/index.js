...
class LifeCycle {
    constructor(ctx) {
        ...
        Object.defineProperty(this, "nextSlot", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: 0
    ...
    buildPanel() {
        ...
        this.ctx.panel.append(el("div", { class: "metric", style: { background: "#1e293b", color: "#fff" } }, el("span", {}, "🔬 Cycle"), el("span", {}, this.cycle.name)), el("div", { class: "control-label", style: { marginTop: "8px" } }, "Tap stages in order"), el("div", { class: "metric" }, el("span", {}, "✅ Placed"), this.progressEl), this.coachEl);
    }
    attach() {
    ...
    drawCard(c, x, y, stage, bg, border) {
        c.fillStyle = bg;
