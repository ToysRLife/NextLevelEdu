...
class Germs {
    constructor(ctx) {
        ...
        Object.defineProperty(this, "germs", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: []
    ...
    buildPanel() {
        ...
        this.ctx.panel.append(el("div", { class: "metric", style: { background: "#1e293b", color: "#fff" } }, el("span", {}, "🎯 Goal"), el("span", {}, "Wash away the germs")), el("div", { class: "control-label", style: { marginTop: "8px" } }, "Drag the sponge over the hands"), el("div", { class: "metric" }, el("span", {}, "🧼 Germs gone"), this.statusEl), this.coachEl);
    }
    scrub(p) {
        if (this.ended)
            return;
    ...
    win() {
        ...
        this.ctx.services.outcome.succeed({
            message: "Squeaky clean! Microbes are tiny living things — soap washes away the harmful germs. But remember, many microbes are helpful, making bread and yogurt!",
            stars,
            resources: { Water: 40 },
        });
    }
    ...
    render() {
        ...
        if (this.brush) {
            ...
            for (let i = 0; i < 4; i++)
                c.fillRect(this.brush.x - 16 + i * 10, this.brush.y - 8, 4, 4);
        }
        c.fillStyle = "#1e3a8a";
