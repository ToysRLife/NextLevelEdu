...
const TIER_ZONE = { junior: 120, explorer: 90, master: 64 };
class Forces {
    constructor(ctx) {
        ...
        Object.defineProperty(this, "zoneW", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        ...
        Object.defineProperty(this, "zoneX", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        });
        Object.defineProperty(this, "pushEl", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
    ...
    buildPanel() {
        const slider = el("input", {
            ...
            oninput: (e) => {
                if (this.phase !== "setup")
                    return;
                this.push = Number(e.target.value);
                this.updateReadout();
            },
        });
        this.chips = el("div", { class: "chip-row" }, ...SURFACES.map((s) => el("button", {
        ...
        this.ctx.panel.append(el("div", { class: "control-label" }, "Surface"), this.chips, el("div", { class: "control-label", style: { marginTop: "8px" } }, "Push Strength"), slider, el("div", { class: "metric" }, el("span", {}, "👋 Force"), this.pushEl), this.goBtn, this.coachEl);
        this.updateReadout();
    }
    updateReadout() {
        ...
        this.coachEl.textContent =
            this.phase === "sliding"
                ...
                : `On ${this.surface.label.split(" ")[1].toLowerCase()}, the box will coast ${this.surface.friction < 0.03
                    ? "a long way"
                    : this.surface.friction > 0.08
                        ? "only a little"
                        : "a fair bit"}. Aim for the green zone!`;
    }
    go() {
        if (this.phase !== "setup")
            return;
