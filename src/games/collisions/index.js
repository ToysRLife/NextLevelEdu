...
class Collisions {
    constructor(ctx) {
        ...
        Object.defineProperty(this, "speed", {
            ...
            writable: true,
            value: 4.0
        }); // launch speed (slider/10)
        Object.defineProperty(this, "cueX", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: 100
        });
        Object.defineProperty(this, "cueV", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: 0
        ...
        Object.defineProperty(this, "endX", {
            ...
            writable: true,
            value: CHAIN_X + 3 * (R * 2)
        }); // the last ball in the chain
        Object.defineProperty(this, "endV", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: 0
        });
        Object.defineProperty(this, "transferred", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: false
        ...
        Object.defineProperty(this, "pocket", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: { x: 600, w: 70 }
        ...
        Object.defineProperty(this, "launchBtn", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
    ...
    buildPanel() {
        ...
        this.launchBtn = el("button", { class: "btn", style: { background: "var(--accent-orange)" }, onclick: () => this.launch() }, "🎱 Launch");
        ...
        this.ctx.panel.append(el("div", { class: "metric", style: { background: "#1e293b", color: "#fff" } }, el("span", {}, "🎯 Goal"), el("span", {}, `Sink ${NEED} shots`)), el("div", { class: "control-label", style: { marginTop: "8px" } }, "🚀 Launch speed"), slider, this.launchBtn, el("div", { class: "metric" }, el("span", {}, "⚡ Speed"), this.speedEl), el("div", { class: "metric" }, el("span", {}, "🥅 Sunk"), this.statusEl), this.coachEl);
        this.updateReadout();
    }
    updateReadout() {
    ...
    tick(dtMs) {
        ...
        const f = dtMs / 16.67;
        if (this.flash > 0)
            this.flash = Math.max(0, this.flash - 0.06 * f);
        if (this.moving) {
            if (!this.transferred) {
    ...
    finish() {
        ...
        this.ctx.services.outcome.succeed({
            message: "Great shots! When a moving ball hits a line of resting ones, it passes its motion straight through — the far ball rolls off with that energy.",
            stars,
            resources: { Fuel: 40 },
        });
    }
