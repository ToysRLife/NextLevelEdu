...
class PlantCycle {
    ...
    buildPanel() {
        ...
        this.ctx.panel.append(el("div", { class: "metric", style: { background: "#1e293b", color: "#fff" } }, el("span", {}, "🎯 Goal"), el("span", {}, "Order the life cycle")), el("div", { class: "control-label", style: { marginTop: "8px" } }, "Pick the next stage"), chips, el("div", { class: "metric" }, el("span", {}, "🌱 Stages placed"), this.statusEl), this.coachEl);
    }
    pick(key) {
        if (this.ended)
            return;
    ...
    win() {
        ...
        this.ctx.services.outcome.succeed({
            message: "Full circle! A plant grows from a seed, sprouts, grows leaves, blooms, and makes new seeds — and the whole cycle starts over again.",
            stars,
            resources: { Seeds: 40 },
        });
    }
