...
const N = 1; // mol
const pressureFor = (tempC, volL) => (N * R * (tempC + 273)) / volL; // kPa
const ROUNDS = [{ target: 200 }, { target: 500 }, { target: 1000 }];
class GasLab {
    constructor(ctx) {
        ...
        Object.defineProperty(this, "vol", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: 10
        ...
        Object.defineProperty(this, "volCtl", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        });
        Object.defineProperty(this, "pRead", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
    ...
    buildPanel() {
        ...
        this.ctx.panel.append(el("div", { class: "metric", style: { background: "#1e293b", color: "#fff" } }, el("span", {}, "🎯 Target pressure"), el("span", {}, `${this.round().target} kPa`)), this.tempCtl.el, this.volCtl.el, this.pRead.el, el("button", { class: "btn", style: { background: "var(--accent-blue)" }, onclick: () => this.check() }, "⏲️ Read the gauge"), el("div", { class: "metric" }, el("span", {}, "✅ Pressures hit"), this.statusEl), this.coachEl);
        this.updateReadout();
    }
    updateReadout() {
    ...
    win() {
        ...
        this.ctx.services.outcome.succeed({
            message: "Pressure pro! Gas pressure comes from particles bouncing off the walls. More heat = faster, harder hits; less volume = more frequent hits. That's P = nRT ÷ V.",
            stars,
