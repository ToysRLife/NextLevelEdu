...
export function renderOnboarding(root, onDone) {
    ...
    const avatarGrid = el("div", { class: "avatar-grid" }, ...AVATARS.map((a) => el("button", {
    ...
    const ideas = el("div", { class: "alias-ideas" }, ...ALIAS_IDEAS.map((idea) => el("button", {
        class: "chip",
        onclick: () => {
            alias = idea;
    ...
    const card = el("div", { class: "onboard-card" }, el("div", { class: "onboard-hero" }, "👋"), el("h1", {}, "Welcome, Explorer!"), el("p", { class: "onboard-sub" }, "Master science to build worlds of your own. First, who are you?"), el("div", { class: "control-label" }, "Choose your avatar"), avatarGrid, el("div", { class: "control-label" }, "Your explorer name"), aliasInput, ideas, startBtn);
    clear(root);
