...
type Strategy = "migrate" | "hibernate" | "active";
...
class Migration implements GameInstance {
  ...
  private choose(s: Strategy): void {
  ...
  private win(): void {
    ...
    this.ctx.services.outcome.succeed({
      message:
        "Everyone made it! To survive winter, animals migrate to warmer places, hibernate through the cold, or stay active with warm coats and stored food.",
      stars,
      resources: { Water: 40 },
    });
  }
...
export const migrationGame: GameModule = {
  meta: {
    id: "migration",
    conceptId: "bio-20",
