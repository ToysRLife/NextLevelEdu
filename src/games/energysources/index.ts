...
class EnergySources implements GameInstance {
  private readonly ctx2d: CanvasRenderingContext2D;
  private raf = 0;
  private anim = 0;
  private ended = false;

  private power = 0; // 0..100
  private built: Built[] = [];
  private mistakes = 0;
  private smog = 0;
  ...
  private win(): void {
    ...
    this.ctx.services.outcome.succeed({
      message:
        "City powered — cleanly! Renewable sources like sun, wind, water, and Earth's heat never run out and don't pollute, unlike coal, oil, and gas.",
      stars,
...
export const energySourcesGame: GameModule = {
  meta: {
    id: "energysources",
    conceptId: "ess-21",
    title: "Power Up",
