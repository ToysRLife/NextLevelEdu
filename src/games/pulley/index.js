...
const ROUNDS = [{ weight: 40 }, { weight: 75 }, { weight: 110 }];
class Pulley {
    constructor(ctx) {
        ...
        Object.defineProperty(this, "pulleys", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: 1
        ...
        Object.defineProperty(this, "hauling", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: false
    ...
    buildPanel() {
        const row = el("div", { class: "chip-row" }, ...[1, 2, 3, 4].map((n) => el("button", {
            class: "chip",
            style: this.pulleys === n
                ? {
        ...
        const haulBtn = el("button", { class: "btn", style: { background: "var(--accent-green)" }, onclick: () => this.haul() }, "🪢 Haul it up");
        ...
        this.ctx.panel.append(el("div", { class: "metric", style: { background: "#1e293b", color: "#fff" } }, el("span", {}, "🎯 Goal"), el("span", {}, "Lift the load")), el("div", { class: "control-label", style: { marginTop: "8px" } }, "How many pulleys?"), row, haulBtn, el("div", { class: "metric" }, el("span", {}, "💪 Force needed"), this.forceEl), el("div", { class: "metric" }, el("span", {}, "📦 Lifted"), this.statusEl), this.coachEl);
        this.updateReadout();
    }
    updateReadout() {
    ...
    finish() {
        ...
        this.ctx.services.outcome.succeed({
            message: "Heave-ho! A pulley system spreads a heavy load across more rope, so each pull takes less force. More pulleys = less effort (but more rope to pull).",
            stars,
            resources: { Alloy: 40 },
        });
    }
